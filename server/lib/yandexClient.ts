...
ЖЁСТКИЕ ТРЕБОВАНИЯ (ОБЯЗАТЕЛЬНО):
1. Заголовок: МАКСИМУМ 56 символов (считай каждый символ!)
2. Текст: МАКСИМУМ 81 символ (считай каждый символ!)
3. ОБЯЗАТЕЛЬНО включи ключевое слово "${firstKeyword}" в заголовок или текст
4. ОБЯЗАТЕЛЬНО добавь призыв к действию: закажи, узнай, получи, звони, запишись
${data.usp ? `5. ОБЯЗАТЕЛЬНО упомяни УТП: ${data.usp}` : ""}
6. Максимальная длина одного слова: 23 символа

ФОРМАТ ОТВЕТА (строго соблюдай):
ВАРИАНТ 1:
Заголовок: [короткий заголовок до 56 символов]
Текст: [короткий текст до 81 символа]

Создай ровно ${data.count} вариантов. Перед ответом ПРОВЕРЬ длину каждого заголовка и текста!`;
}
